...
export default function Footer() {
  return (
    <div
      className={` bottom-0  bg-[#f52f2f] flex flex-col justify-between gap-20 text-white p-4 border-t-2 border-white ${SpaceBold.className}`}
    >
      <div className=" flex justify-start flex-col  gap-4 w-full sm:w-4/5 sm:flex-row sm:gap-28">
        ...
        <div className="flex-1 flex flex-col gap-2">
          ...
          />
          <button
            className={` bg-black py-2 px-8 rounded-md text-white w-max ${MontserratBold.className}`}
          >
            Sign Me Up
          </button>
        </div>
